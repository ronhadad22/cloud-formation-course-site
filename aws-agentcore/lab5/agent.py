...
if __name__ == "__main__":
    ...
    print("  2. Run: ./deploy.sh my-langgraph-agent eu-central-1")
    print("\nOr manually:")
    print("  agentcore configure --agent my-langgraph-agent --entrypoint agent.py")
    print("  agentcore deploy --agent my-langgraph-agent")
